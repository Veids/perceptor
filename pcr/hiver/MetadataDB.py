    ...
    def store(self):
        ...
        if self.exports:
            if isinstance(self.exports, Link):
                if self.exports.output.obj:
                    exports = json.dumps(self.exports.output.obj.get("exports"))
...
signature length: {len(signature_blob or [])}""")
        ...
        self.output = Artifact(
            ...
            obj = {
                ...
                "manifest_directory_config": json.loads(metadata.manifest_directory_config) if metadata.manifest_directory_config else None,
                "signature": signature_blob,
