...
class PExtractor(Link):
    ...
    def extract_manifest(self, target):
    ...
    def extract_version(self, target):
    ...
    def process(self):
        ...
        actions = {
            EntityEnum.icon: self.extract_icon,
            EntityEnum.manifest: self.extract_manifest,
            EntityEnum.version: self.extract_version,
            EntityEnum.exports: self.extract_exports,
            EntityEnum.rich_header: self.extract_rich_header,
            EntityEnum.optional_header: self.extract_optional_header,
        }

        actions[self.entity](target)
